...
SAYS = \
    {'reset.py': {'error state is None': f'&#9888 В моей программе произошла непредвиденная ошибка, попробуйте ещё раз '
     ...
     'start.py': {'user': '<b>Что умеет бот:</b>\nБот показывает <b>НАСТОЯЩИЕ</b> рекламные ставки в личном кабинете '
                          ...
                          # 'доступно 30 запросов). Пригласите 3-х и более человек - получите +300 к количеству запросов '
                          # f'за каждого последующего.\n\n '
                          f'Поддержка: @{SUPPORT}',
                  # Перед активацией этого текста нужно убрать коммент из файла get_first_keyboard.py для
                  # уменьшения баланса запросов
                  },
     ...
     'response_request.py': {'not response': '&#129302 <b>К сожалению по вашему запросу ничего не найдено, '
                                             'возможно фраза написана с ошибками. Попробуйте '
